...
class JsonWorldComponentContentPaths:
    ...
    @classmethod
    def FromManifest(cls, value: dict):
        return cls(
            value["Response"]["jsonWorldComponentContentPaths"]["en"],
            value["Response"]["jsonWorldComponentContentPaths"]["fr"],
            value["Response"]["jsonWorldComponentContentPaths"]["es"],
            value["Response"]["jsonWorldComponentContentPaths"]["es-mx"],
            value["Response"]["jsonWorldComponentContentPaths"]["de"],
            value["Response"]["jsonWorldComponentContentPaths"]["it"],
            value["Response"]["jsonWorldComponentContentPaths"]["ja"],
            value["Response"]["jsonWorldComponentContentPaths"]["pt-br"],
            value["Response"]["jsonWorldComponentContentPaths"]["ru"],
            value["Response"]["jsonWorldComponentContentPaths"]["pl"],
            value["Response"]["jsonWorldComponentContentPaths"]["ko"],
            value["Response"]["jsonWorldComponentContentPaths"]["zh-cht"],
            value["Response"]["jsonWorldComponentContentPaths"]["zh-chs"]
        )
